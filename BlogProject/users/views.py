...
from BlogProject.users.forms import LoginForm, RegistrationForm, UpdateUserForm
...
#login is required for updating the user profile
@login_required
def account():
    form = UpdateUserForm()
...
def user_posts(username):
    ...
    ## cycle through user posts using pages
